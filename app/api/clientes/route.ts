...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    // Verificar permissões (em produção, isso deveria vir de um middleware de autenticação)
    // Por enquanto, vamos confiar na validação do frontend
    // Em produção, implementar JWT ou sessão server-side
